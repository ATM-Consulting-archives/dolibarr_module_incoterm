...
class modIncoterm extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//	                       );
		$this->module_parts = array('hooks'=>array('projectcard','propalcard','ordercard','invoicecard','expeditioncard','receptioncard','thirdpartycard','ordersuppliercard'),'triggers'=>1);
