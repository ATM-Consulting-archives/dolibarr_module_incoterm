...
class modIncoterm extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//	                       );
		$this->module_parts = array('hooks'=>array('projectcard','propalcard','ordercard','invoicecard','expeditioncard','shipmentcard','thirdpartycard'),'triggers'=>1);
		...
		$this->langfiles = array("incoterm@incoterm");
	...
	function init($options='')
	{
		...
		$url ='http://'.$_SERVER['SERVER_NAME']. DOL_URL_ROOT_ALT."/incoterm/script/create-maj-base.php";
	...
	{
		return $this->_load_tables('/incoterm/sql/');
	}
}
